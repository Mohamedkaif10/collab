...
const Profile=()=>{
    ...
    return (
      ...
      justifyContent: 'space-between',
         ...
         >
              ...
              <p>Created at {new Date(bookmark.created_at).toLocaleDateString()}</p>
    ...
    <li>Department: {bookmark.department_name}</li>
              ...
              {/* <p>Duration: {bookmark.duration} months</p> */}
  
              
          <hr></hr>
         
              <Button  variant="contained" style={{ alignSelf: 'flex-end' ,backgroundColor: '#FFC20E',color: '#253D90', }}>Apply</Button>
            </Box>
        ))}
      </div>
        </Fragment>
