...
const CreateProfileForm = () => {
  ...
  return (
    ...
    <Fragment>
        ...
        <Typography sx={{marginTop:'1%'}}>Provide these details to make your profile and Find a job & grow your career</Typography>
  ...
  <div className="mb-4">
    <label htmlFor="work_status" className="block text-sm font-medium text-gray-700">
      Work Status
    </label>
    <input
      type="text"
...
<div>
  <div className="mb-4">
    ...
    <label htmlFor="image" className="block text-sm font-medium text-gray-700">
      ...
      <Button sx={{}} type="submit" variant="contained" color="primary" onClick={handleSubmit}>
        Create Profile
      </Button>
    </div>
    </Fragment>
