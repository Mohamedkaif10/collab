  ...
  const fetchJobDetails = async () => {
    try {
      const response = await axios.get(
        "http://localhost:8002/api/job_details/user"
      );
            ...
            {postings.map((posting) => (
              ...
              >
                ...
                >
                  ...
                  <DeleteIcon
                    onClick={() => handleDeleteClick(posting.job_id)}
                  />
                </Box>
                ...
                <div style={{ display: "flex", alignItems: "center" }}>
                  ...
                  <p>
                    Apply Before:{" "}
                    {new Date(posting.last_date).toLocaleDateString()}
                  </p>
                </div>
                ...
                <Button
                  onClick={() => handleApplyClick(posting.pdf_id)}
                  variant="contained"
                  style={{
                    alignSelf: "flex-end",
